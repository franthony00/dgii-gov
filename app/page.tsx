...
import { CheckCircle2, ScanLine, RotateCcw } from "lucide-react";
...
export default function ScannerPage() {
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      if (!validation.valid) {
        setValidationError(
          `No se pudieron detectar: ${validation.missing.join(", ")}.`
        );
      }
  ...
  const handleSubmit = async (data: OCRResult) => {
    ...
    try {
      const codigo = await saveVehicleData({
        ...
        // IMPORTADOR
        razonSocialNombreImportador: data.razonSocialNombreImportador || "",
        rncCedulaImportador: data.rncCedulaImportador || "",

        // COMPRADOR
        razonSocialNombreComprador: data.razonSocialNombreComprador || "",
        rncCedulaComprador: data.rncCedulaComprador || "",
      });
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ color: "#64748b", fontSize: "1.1rem" }}>
            Sube una imagen o PDF de tu documento vehicular para extraer la
        ...
        >
          ...
          {step === "qr" && generatedCode && (
            ...
            >
              ...
              >
                ¡Documento procesado! Código generado:{" "}
